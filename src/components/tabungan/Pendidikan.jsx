      ...
      <section className="tabungan">
        <div className="container gridAbout">
          ...
          <div className="right row">
            ...
            <div id="heading">
              <h1>
                Tabungan <text>iB</text> Hebat Rencana Pendidikan
              </h1>
            </div>
            <div className="items">
              <div className="item">
                <p>
                  Tabungan iB Hebat Rencana Pendidikan adalah Produk Tabungan
                  Rencana yang dikeluarkan oleh BPRS DANA AMANAH [BDA],
                  dikhususkan untuk Nasabah Perorangan yang memiliki perencanaan
                  keuangan untuk Pendidikan dengan menabung secara rutin setiap
                  bulan dan dengan nominal tertentu serta merencanakan tabungan
                  tersebut untuk Pendidikan tertentu, misal Pendidikan anak
                  untuk masuk SD, untuk Masuk SMP, untuk SMA, Kuliah dan
                  lainnya. Produk ini berdasar prinsip syariah islam dengan
