      ...
      <section className="tabungan">
        <div className="container gridAbout">
          ...
          <div className="right row">
            ...
            <div id="heading">
              <h1>
                Tabungan <text>iB</text> Hebat Rencana Multi
              </h1>
            </div>
            <div className="items">
              <div className="item">
                <p>
                  Tabungan iB Hebat Rencana Multipro adalah Produk Tabungan
                  Rencana yang dikeluarkan oleh BPRS DANA AMANAH [BDA],
                  dikhususkan untuk Nasabah Perorangan yang memiliki perencanaan
                  keuangan kedepan dengan menabung secara rutin setiap bulan dan
                  dengan nominal tertentu,Produk ini berdasar prinsip syariah
                  islam dengan menggunakan akad mudharabah.
                  <p>
