        ...
        <div className="container gridAbout">
          ...
          <div className="right row">
            ...
            <div className="items">
              <div className="item">
                <p>
                  Tabungan iB Hebat Mudharabah adalah Produk Tabungan yang
                  dikeluarkan BPRS DANA AMANAH [BDA], yang dimiliki oleh Nasabah
                  Perorangan maupun Lembaga. Produk ini hanya tersedia dalam
                  prinsip syariah dengan menggunakan akad Mudharabah Muthlaqah,
                  selama menabung Nasabah akan mendapatkan Bagi Hasil pada
                  setiap bulannya. Produk Tabungan ini dijamin LPS (Lembaga
                  Penjamin Simpanan) dengan maksimal Tabungan Rp. 2 Milyar.
                </p>
              </div>
              <div className="item">
